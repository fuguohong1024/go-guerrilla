...
import (
	...
	"github.com/fuguohong1024/go-guerrilla"
	"github.com/fuguohong1024/go-guerrilla/log"

	// enable the Redis redigo driver
	_ "github.com/fuguohong1024/go-guerrilla/backends/storage/redigo"

	// Choose iconv or mail/encoding package which uses golang.org/x/net/html/charset
	//_ "github.com/fuguohong1024/go-guerrilla/mail/iconv"
	_ "github.com/fuguohong1024/go-guerrilla/mail/encoding"
